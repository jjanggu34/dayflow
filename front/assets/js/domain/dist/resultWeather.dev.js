...
(function (global) {
  ...
  function buildOpenMeteoUrl(lat, lon) {
    var q = "latitude=" + encodeURIComponent(lat) + "&longitude=" + encodeURIComponent(lon) + "&current=temperature_2m,relative_humidity_2m,weather_code" + "&timezone=auto";
  ...
  function fillResultStatusCards(opts) {
    var o = opts || {};
    return loadWeatherSnapshot().then(function (snap) {
      setDom(o.ids || {}, snap);
      return snap;
    })["catch"](function () {
...
//# sourceMappingURL=resultWeather.dev.js.map
