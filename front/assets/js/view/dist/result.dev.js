...
(function () {
  ...
  var PACKS = {
    best: {
      ...
      moodLabel: "활기찬",
      total: 88,
      chatSummaryFallback: "오늘은 스스로에게 힘을 실어 주며 하루를 밀도 있게 보내신 것 같아요. 하고 싶은 일에 몰입하고, 쉴 때는 가볍게 숨 고르기도 잘하셨어요.",
      tags: ["#성취", "#에너지"],
      metrics: [{
        name: "에너지",
        value: 88
      ...
      insights: ["오늘은 스스로를 믿고 나아가기 좋은 날이에요.", "밝은 마음이 주변과의 대화도 더 수월하게 만들어요."]
    },
    good: {
      ...
      moodLabel: "평온함",
      total: 72,
      chatSummaryFallback: "해야 할 일을 차근차근 정리하고 중요한 일에 집중하면서, 일과 휴식의 균형 속에 무리 없이 하루를 마무리했어요.",
      tags: ["#안정", "#집중"],
      metrics: [{
        name: "에너지",
        value: 65
      ...
      insights: ["오전의 집중이 하루 전체 흐름을 잡아줬어요.", "평온한 상태에서 깊은 작업이 잘 돼요."]
    },
    normal: {
      ...
      moodLabel: "평온",
      total: 58,
      chatSummaryFallback: "특별한 일정 없이도 나만의 속도로 하루를 지나가셨어요. 익숙한 루틴이 마음을 조용히 받쳐 주었을 거예요.",
      tags: ["#일상", "#정리"],
      metrics: [{
        name: "에너지",
        value: 55
      ...
      insights: ["무난한 날에는 작은 성취 하나만 챙겨도 충분해요.", "감정 기복이 크지 않을 때는 루틴을 살짝 바꿔 보세요."]
    },
    bad: {
      headline: "조금 무거웠던 하루",
      ...
      moodLabel: "처짐",
      total: 42,
      chatSummaryFallback: "몸이나 마음이 무거운 순간도 있었지만, 그래도 하루를 지나오셨어요. 오늘은 조금 덜 해도 괜찮다는 걸 스스로에게도 말해 주세요.",
      tags: ["#회복", "#휴식"],
      metrics: [{
        name: "에너지",
        value: 38
      ...
      insights: ["의욕이 떨어질 땐 목표를 아주 작게 나눠 보세요.", "가벼운 산책이나 스트레칭이 부담을 덜어 줄 수 있어요."]
    },
    worst: {
      headline: "버거움이 큰 하루",
      ...
      moodLabel: "고강도 스트레스",
      total: 28,
      chatSummaryFallback: "버거움이 큰 하루였을 수 있어요. 지금은 잠시 멈춰 서도 되는 구간일지도 몰라요. 혼자 다 짊어지지 않아도 괜찮습니다.",
      tags: ["#안전", "#지지"],
      metrics: [{
        name: "에너지",
        value: 22
      ...
      insights: ["당장 해결하지 않아도 괜찮은 일들이 있어요.", "수면과 식사, 물처럼 기본 리듬을 먼저 챙겨 주세요."]
    }
  };
  ...
  function renderMetrics(listEl, metrics) {
    ...
    for (var i = 0; i < metrics.length; i++) {
      ...
      li.innerHTML = '<p class="result-metrics__value-top"></p>' + '<div class="result-metrics__bar-wrap"><div class="result-metrics__bar"><div class="result-metrics__fill"></div></div></div>' + '<span class="result-metrics__name"></span>';
  ...
  function init() {
    ...
    if (typeof window.DayflowResultWeather !== "undefined" && DayflowResultWeather.fillResultStatusCards) {
      DayflowResultWeather.fillResultStatusCards({
        onFail: setPlaceholderStats
      });
    } else {
      setPlaceholderStats();
    }
...
//# sourceMappingURL=result.dev.js.map
